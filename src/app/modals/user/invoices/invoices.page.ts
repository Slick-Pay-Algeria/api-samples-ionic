...
export class UserInvoicesPage implements OnInit {
    ...
    public async tryCommission() {
        ...
        this.httpClient.post(`https://devapi.slick-pay.com/api/v2/users/invoices/commission`, {
            "amount": 1000
        }, {
            headers: new HttpHeaders({
    ...
    public async tryCreate() {
        ...
        this.httpClient.post(`https://devapi.slick-pay.com/api/v2/users/invoices`, {
            "amount": 10000,
            "contact": "37990d08-fc51-4c32-ad40-1552d13c00d1",
            "url": "https://my-website.com/thank-you-page",
            "items": [
    ...
    public async tryDetails() {
        ...
        this.httpClient.get(`https://devapi.slick-pay.com/api/v2/users/invoices/1`, {
            headers: new HttpHeaders({
                'Authorization': `Bearer ${value}`
            })
        })
    ...
    public async tryList() {
        ...
        this.httpClient.get(`https://devapi.slick-pay.com/api/v2/users/invoices?offset=1&page=1`, {
            headers: new HttpHeaders({
                'Authorization': `Bearer ${value}`
            })
        })
    ...
    public async tryUpdate() {
        ...
        this.httpClient.put(`https://devapi.slick-pay.com/api/v2/users/invoices/1`, {
            "url": "https://my-website.com/thank-you-page"
        }, {
            headers: new HttpHeaders({
                'Authorization': `Bearer ${value}`
    ...
    public async tryDelete() {
        ...
        this.httpClient.delete(`https://devapi.slick-pay.com/api/v2/users/invoices/1`, {
            headers: new HttpHeaders({
                'Authorization': `Bearer ${value}`
            })
        })
