...
export class MerchantAuthPage implements OnInit {
    ...
    public breadcrumbs: Array<any> = [
        ...
        {
            label: this.translateService.instant('merchant'),
        },
        {
    ...
    public async try() {
        ...
        // get merchant key from localStorage
        const { value } = await Storage.get({
            key: Constants.KEY_MERCHANT_KEY
        });

        this.httpClient.get('https://devapi.slick-pay.com/api/v2/merchants', {
                headers: new HttpHeaders({
